...
if __name__ == "__main__":
    ...
    weight_path = '/PublicData/xmm/project/Pan-Mamba/experiment/05-06_20:38_PanMambaForWV4/epoch=940.pth'
    # validation
    ...
    # full = True
    full = False
    save_root = '/PublicData/cjj/UnifiedPansharpening/PanMamba2025IF'
    ...
    with torch.no_grad():
        # 初始化模型 (使用与训练相同的参数)
        Generator = Net(channel, base_filter=32).cuda()
